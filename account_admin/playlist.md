...
<div class="description">
    ...
    <p>
        In the left side panel if the Playlists was selected the Admin will see this screen. This is where the Admin will be able to view all of the created and available playlists under their account. On this page, the Admin will be able to create a new playlist, configure existing playlists and delete playlists.
    </p>
</div>
