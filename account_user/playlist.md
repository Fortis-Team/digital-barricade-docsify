...
<div class="description">
    <p>
        To edit the chosen playlist, simply click the pencil icon. This action will open a modal where the user can customize the playlist according to their preferences. Once the changes have been made, the user can save them by clicking the update item button located at the bottom of the modal.
    </p>
