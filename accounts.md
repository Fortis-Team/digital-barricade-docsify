...
<!-- !> Only the **user** has access to the **Manage Accounts** tab in the Digital Barricade Website.     -->
...
<div class="description">
    ...
    <p>
        Once the modal appears, the user can now update the necessary input fields.
    </p>
