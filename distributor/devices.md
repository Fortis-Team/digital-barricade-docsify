...
<div class="description">
    <p>
        To unregister a device, the distributor must click the unregister in the dropdown menu and a modal will appear.Unregistering the device shall disconnect the device from the system and will not receive any upcoming updates unless it is re-registered through the phone app.
    </p>
    <p>
